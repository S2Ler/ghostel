...
The default accepts inline data only.  When other mediums are enabled,
a program running remotely \(SSH, tmux passthrough) can make ghostel
read local files or shared memory.  Enable them only for trusted use."
